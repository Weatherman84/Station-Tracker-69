...
MODELS = [
    "ecmwf_ifs025", "ecmwf_aifs025", "gfs_seamless", "icon_seamless", "icon_eu",
    "meteofrance_seamless", "ukmo_seamless", "gem_seamless", "jma_seamless",
]
RESTRICTED_MODELS = {"knmi_harmonie_arome_netherlands": {"amsterdam"}}

LEADS = [1, 2, 3, 4, 5, 6, 7]
BACKFILL_START = "2024-01-01"   # earliest most models are archived from
CHUNK_DAYS = 180                # split requests into ~6-month windows
